export default {
    ...
    colors: {
        text: '#001B48', // body color and primary color
        text_secondary: '#02457A', // secondary body color
        heading: '#244886', // primary heading color
        heading_secondary: '#0F2137', // heading color
        background: '#FFFFFF', // body background color
        background_secondary: '#D6E8EE', // secondary background color
        border_color: '#E5ECF4', // border color
        primary: '#02457A', // primary button and link color
        secondary: '#018ABE', // secondary color - can be used for hover states
        muted: '#97CADB', // muted color
